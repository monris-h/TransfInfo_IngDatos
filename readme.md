...
Al abrir la página se solicita únicamente un nombre de usuario. El botón **Usuarios activos** muestra el total y abre la lista en un modal. Cada pestaña mantiene su sesión en el servidor mediante una actualización periódica; se retira al cerrar sesión o la página y caduca tras 90 segundos sin actividad. Es una función de presencia, no un sistema de autenticación: las sesiones se guardan en memoria y se reinician al detener el servidor.
